...
# Extracting functions to reduce line count can trigger too_many_arguments (>7 args) — bundle
# related parameters into a struct when the extracted function needs more than 7.
