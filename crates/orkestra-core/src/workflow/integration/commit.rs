...
//!
//! TODO: Convert to interactions:
//! - `interactions/commit_worktree.rs` — commit pending changes
//! - `interactions/generate_commit_message.rs` — build commit message with attribution
//!
