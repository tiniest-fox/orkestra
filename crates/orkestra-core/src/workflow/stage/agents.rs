...
//!
//! TODO: Extract `execute_stage()` core logic into an interaction that takes
//! explicit dependencies (prompt, schema, config). The service retains only
//! process lifecycle management and delegates execution setup to the interaction.
//!
