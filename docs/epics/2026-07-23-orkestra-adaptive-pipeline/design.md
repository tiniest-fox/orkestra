...
1. Chat: human describes wanting the frontmatter-parsing system plus `ork technique list`/`show` commands to inspect it. The composer recognizes this splits into genuinely independent pieces (parsing vs. CLI surface), not just "big."
2. Composer proposes:
