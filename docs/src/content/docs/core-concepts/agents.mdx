...
Session continuity is scoped to a stage. Moving to a new stage always starts a new session. Within a stage, sessions persist across iterations — the agent sees its full conversation history including every rejection and gate failure.
