...
Agent stages can be extended with [capabilities](/docs/core-concepts/capabilities) that change what the agent can produce. The Subtraks capability allows the agent to decompose the Trak into child Traks. Every stage can ask questions without any capability flag.
