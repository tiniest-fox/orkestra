...
Auto mode is a Trak-level setting. It applies to every stage uniformly; there is no per-stage automation flag. Auto mode can be set at Trak creation time or toggled later via the CLI or API.
