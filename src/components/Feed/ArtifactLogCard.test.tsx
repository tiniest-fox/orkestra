// Unit tests for ArtifactLogCard component.
...
describe("ArtifactLogCard", () => {
  ...
  it("shows 'No content' when content is empty and html is absent", () => {
    const artifact: WorkflowArtifact = {
      ...baseArtifact,
      content: "",
      html: undefined,
  ...
  it("is keyboard accessible via button role", () => {
    render(<ArtifactLogCard artifact={baseArtifact} />);
    const header = screen.getByRole("button");
    // Native button elements activate on Enter/Space — verify the element is a button
