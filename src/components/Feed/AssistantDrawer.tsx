...
export function AssistantDrawer({ onClose }: AssistantDrawerProps) {
  ...
  const isAgentRunning =
    activeSession?.session_state === "active" || activeSession?.session_state === "spawning";
      ...
      <div className="flex flex-col h-full relative overflow-hidden">
        ...
        <div ref={messageListRef} className="flex-1 overflow-y-auto bg-canvas">
          ...
          {displayMessages.map((msg, i) => {
            ...
            const isLastAgent =
              msg.kind === "agent" && displayMessages.slice(i + 1).every((m) => m.kind !== "agent");
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            {sessions.length === 0 && (
              <div className="p-4 font-mono text-[11px] text-text-quaternary">No sessions yet.</div>
            )}
