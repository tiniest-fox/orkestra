          ...
          <>
            <button
              ...
              className={[
                ...
                selectedHash === null
                  ? "bg-accent-soft border-l-2 border-l-accent !pl-[10px] text-text-primary font-semibold"
            ...
            {commits.map((commit) => (
              ...
              >
                <div className="flex items-center gap-1.5">
                  <span className="font-mono text-forge-mono-label text-text-quaternary bg-canvas px-[5px] py-[1px] rounded shrink-0">
                    {commit.hash}
                  </span>
