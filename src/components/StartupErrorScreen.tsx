    ...
    <div className="h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900">Startup Failed</h1>
            <p className="text-sm text-gray-500">Please fix the issues below and try again</p>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-6">
          {errors.map((error) => (
            ...
            >
              ...
              {error.remediation && (
                <div className="flex items-start gap-2 text-sm text-gray-600 bg-white/60 rounded p-2 mt-2">
                  <span className="text-blue-500 flex-shrink-0">Tip:</span>
