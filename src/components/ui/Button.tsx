...
type ButtonVariant = "primary" | "secondary" | "ghost" | "destructive" | "warning" | "info";
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  warning:
    "bg-warning-500 text-white hover:bg-warning-600 active:bg-warning-700 disabled:bg-warning-300 dark:disabled:bg-warning-800",
  info: "bg-info-500 text-white hover:bg-info-600 active:bg-info-700 disabled:bg-info-300 dark:disabled:bg-info-800",
};
