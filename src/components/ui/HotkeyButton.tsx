...
export const HotkeyButton = forwardRef<HTMLButtonElement, HotkeyButtonProps>(
  function HotkeyButton({ hotkey, label, onAccent = false, children, onClick, ...props }, ref) {
        ...
        <AnimatePresence>
          {active && (
            <motion.span
              ...
              animate={{ opacity: onAccent ? 0.75 : 0.55, maxWidth: 28, paddingLeft: 2, paddingRight: 2, marginRight: 6 }}
