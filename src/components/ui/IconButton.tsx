...
export function IconButton({
  ...
  const baseStyles =
    "inline-flex items-center justify-center rounded-panel-sm transition-colors focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
